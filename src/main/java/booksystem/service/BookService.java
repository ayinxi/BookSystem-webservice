...
//    List<Book>getBookByPress(String press);
    ...
    //单次添加
    int addBook( String book_name, String author, double price, int volume, int repertory, String press, int edition, String print_time,String category_id,String shop_id);
    //单次删除
